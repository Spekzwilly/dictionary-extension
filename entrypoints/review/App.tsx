...
import { createSession, rate, isSessionDone, currentCard } from '../../lib/review-session'
import type { SessionState } from '../../lib/review-session'
...
export default function ReviewApp() {
  ...
  function handleRate(r: 'easy' | 'hard' | 'again') {
    if (!session) return
    setFlipped(false)
    setTimeout(() => setSession(s => s ? rate(s, r) : s), 100)
  }
