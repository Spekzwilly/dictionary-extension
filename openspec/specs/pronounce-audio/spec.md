# pronounce-audio Specification

## Purpose

Defines the pronunciation playback capability across all surfaces (extension definition popup, web app `/vocab`, and web app `/review`). Covers the Pronounce control UI, accent preference, hybrid human-audio + TTS fallback chain, and IPA phonetic display.
